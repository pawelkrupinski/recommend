...
export const MESSAGES = {
  en: {
    ...
    'settings.indie': 'Independent only — no major studios',
    'settings.saveOrigin': 'Save origin filters',
    'origin.anyContinent': 'Any continent',
  ...
  pl: {
    ...
    'settings.indie': 'Tylko niezależne — bez dużych wytwórni',
    'settings.saveOrigin': 'Zapisz filtry pochodzenia',
    'origin.anyContinent': 'Dowolny kontynent',
