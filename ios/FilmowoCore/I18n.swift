...
public enum I18n {
    ...
    public static let en: [String: String] = [
        ...
        "nav.search": "Search",
        "search.placeholder": "Search films & series by name",
        "search.prompt": "Search for a title to see where it's streaming, rate it, or save it.",
        "search.empty": "No titles match your search.",
    ...
    public static let pl: [String: String] = [
        ...
        "nav.search": "Szukaj",
        "search.placeholder": "Szukaj filmów i seriali po nazwie",
        "search.prompt": "Wyszukaj tytuł, aby zobaczyć gdzie go obejrzeć, ocenić go lub zapisać.",
        "search.empty": "Brak tytułów pasujących do wyszukiwania.",
