...
// genre filter. The three stub picks span the axes: 201 US/major,
// 202 FR/indie, 203 JP/indie (see tmdb-stub.js).
test('origin dropdown and toggles filter the Discover picks live', async ({ page }) => {
  ...
  // All three stub picks show, and the controls are present in picks mode.
  ...
  // Back to any origin, then exclude US — the US/major title drops, two remain.
